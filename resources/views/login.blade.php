...
<body class="min-h-screen bg-cover bg-no-repeat" style="background-image: url('{{ asset('src/wall.jpg') }}'); font-family: Arial, sans-serif;">
    <!-- Header Section -->
    <div class="flex items-center justify-end space-x-4 p-4 m-auto">
    ...
    <form action="{{ route('login.post') }}" method="POST" class="flex justify-center items-center pt-10">
        ...
        <div class="relative flex flex-col px-12 py-12 bg-blue-200 bg-opacity-60 rounded-lg shadow-lg">
            ...
            <p class="text-center text-2xl font-bold text-white ">REGISTER FORM</p>

            <!-- Email Input -->
            <div class="flex flex-row items-center gap-2 mb-4 gap-x-3 pt-12">
            ...
            <div class="flex flex-col pt-4 ">
                <button type="submit" class="bg-blue-400  text-white px-4 py-2 rounded-md hover:bg-red-500  font-semibold ">
                    LANJUT
                </button>
                <a href="{{ route('register') }}" class="text-sm font-normal text-white italic hover:text-red-500">Belum punya akun?</a>
